<?php
    ...
    $todasCategorias    = $categorias->listaTodasCategorias("todas");
...
<body id="page-top" onclick="removeListaAutoComplete();">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Serviços - Categorias</h1>
                    <p>
                        Realize a criação de categorias para seus respectivos serviços médicos.
                    </p>
                    <i>Exemplo: Categoria de Serviços de Consultas, Categoria de Serviços de Exames etc...</i>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Criação de Categoria de Seriços:</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form action="../Servicos/recebe_dados_categoria_servico.php" method="post" id="formulario_servico_categoria">

                                        <input type="hidden" name="acao" value="inserir">

                                        <div class="mb-2">
                                            <label for="nome_categoria" class="label_nome_categoria">Nome da Categoria</label>
                                            <input type="text" class="form-control" id="nome_categoria" name="nome">
                                        </div>

                                        <div class="mb-2">
                                            <label for="descricao">Descrição da Categoria   <span class="text-primary">(Opcional)</span></label>
                                        ...
                                        <div class="botao_categoria text-center">
                                            <button type="button" class="btn btn-facebook btn-sm" id="botao_salva_categoria_servico">Salvar Categoria</button>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if($todasCategorias){?>
                                        ...
                                        <?php foreach($todasCategorias AS $key => $cadaCategoria){?>
                                            ...
                                            <?php if($cadaCategoria['status'] == "inativa"){?>
                                                <b class="text-danger">
                                            ...
                                            <div class="modal fade" id="exibeDetalhesCategoria<?=$key?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    ...
                                                    <form action="../Servicos/recebe_dados_categoria_servico.php" method="post">

                                                        <input type="hidden" name="acao" value="atualizar">

                                                        <input type="hidden" name="codigoCategoria" value="<?=$cadaCategoria['codigo_servico_categoria']?>">

                                                        <div class="modal-content">
    
                                                            <div class="modal-header">
    
                                                                <h5 class="modal-title" id="exampleModalLabel"><i class='bx bx-edit-alt mr-2 text-primary'></i>   Dados da Categoria</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" class="form-control" name="nome" value="<?=$cadaCategoria['nome']?>" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <select name="status" id="status" class="form-control">
                                                                            ...
                                                                            <?php if($cadaCategoria['status'] == "ativa"){?>
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        ...
                                                                        <textarea name="descricao" id="descricao" class="form-control"><?=$cadaCategoria['descricao']?></textarea>
                                                                    </div>
                                                                </div>
                                    ...
                                    <hr>
                                    Clique no link abaixo para gerar o relatório de categorias! 
                                    <br>
                                    <a href="../Relatorios/grupos.php?categoria=todas" target="_blank">
                                        <code>categorias</code> .pdf
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../Public/js/verifica_categoria_servico.js"></script>
